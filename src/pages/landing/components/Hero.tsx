      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center py-16 md:py-24">
          ...
          <div className="text-center md:text-left">
            ...
            <h1 className="mt-4 text-4xl md:text-5xl lg:text-6xl font-extrabold text-slate-900 dark:text-white tracking-tight">
              {HERO_COPY.h1}
            </h1>
            <p className="mt-6 text-lg text-slate-600 dark:text-slate-300 max-w-xl mx-auto md:mx-0">
              {HERO_COPY.subtitle}
            </p>
